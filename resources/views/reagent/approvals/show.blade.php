                    ...
                    <div class="panel-body">
                        <div class="profile-user-info profile-user-info-striped">
                            ...
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value"><span>{{ $reagent->desc_campus }}</span></div>
                            </div>

                            <div class="profile-info-row">
                                <div class="profile-info-name">Carrera</div>
                                <div class="profile-info-value"><span>{{ $reagent->desc_carrera }}</span></div>
                            </div>

                            <div class="profile-info-row">
                                <div class="profile-info-name">Menci&oacute;n</div>
                                <div class="profile-info-value"><span>{{ $reagent->desc_mencion }}</span></div>
                            </div>

                            <div class="profile-info-row">
                                <div class="profile-info-name">Materia</div>
                                <div class="profile-info-value"><span>{{ $reagent->desc_materia }}</span></div>
                            </div>

                            <div class="profile-info-row">
                                <div class="profile-info-name">Responsable</div>
                                <div class="profile-info-value"><span>{{ $reagent->usr_responsable }}</span></div>
                            </div>

                            <div class="profile-info-row">
                                <div class="profile-info-name">Estado</div>
                                <div class="profile-info-value"><span>{{ $reagent->desc_estado }}</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="panel-body">
                        <div class="profile-user-info profile-user-info-striped">
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value"><span>{{ $reagent->desc_formato }}</span></div>
                            </div>

                            <div class="profile-info-row">
                                <div class="profile-info-name">Contenido</div>
                                <div class="profile-info-value"><span>{{ $reagent->desc_contenido }}</span></div>
                            </div>
                    ...
                    <div class="panel-body">
                        <div class="profile-user-info profile-user-info-striped">
                            <div class="profile-info-row">
                                ...
                                <div class="profile-info-value"><span>{{ $reagent->desc_campo }}</span></div>
                            </div>
